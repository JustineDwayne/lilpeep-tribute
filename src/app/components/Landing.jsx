...
import lp from "public/lilpeep1.png";
export default function Landing() {
    return (
        <section className=" min-h-screen bg-gradient-to-r from-rose-500 to-pink-900 overflow-hidden shadow-xl">
            ...
            <div className="absolute inset-0 opacity-100 mix-blend-lighten">
                <Image src={lp} alt="Lil Peep Logo" fill className="object-cover" priority />
            </div>
            {/* Top Left Text */}
